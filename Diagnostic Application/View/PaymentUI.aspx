        ...
        <div>
            <table class="table table-payment">
                <tbody>
                    ...
                    <tr>
                        <td class="auto-style1"><label class="control-label">Due Amount</label></td>
                        <td class="auto-style1"><asp:Label ID="DueAmountLabel" runat="server" Text="N/A"></asp:Label></td>
                    </tr>
...
<asp:Content ID="Content1" runat="server" contentplaceholderid="header_section">
    <style type="text/css">
        .auto-style1 {
            height: 23px;
        }
